  ...
  return (
    <main className="landing-page">
      ...
      <section className="landing-hero" id="top">
        ...
        <div className="hero-product">
          <div className="product-window">
            ...
            <Image src="/landing/admin-center-dashboard.png" width={1580} height={1000} priority alt="Aegis Microsoft 365 report center showing a unified Hybrid Active Directory dashboard" />
          </div>
      ...
      <section className="landing-section product-tour" id="product-tour">
        ...
        <div className="tour-image"><Image src="/landing/explorer-360.png" width={1580} height={1000} alt="Explorer 360 displaying a global workforce directory and complete user risk profile" /><span>Explorer 360 · User intelligence</span></div>
      </section>
