...
| --- | --- | --- | --- | --- |
| Command center | Posture, findings, navigation, tenant and notification controls | Pass | Personalize data and actions by effective role | Implemented role-filtered navigation and signed identity |
...
| Value center | Assumptions, calculation and proposal export | Pass | Record model/version used for a business case | P2 product enhancement |
...
| Alerts | Policy list, search, review and action entry points | Pass | Persist alert-policy edits and evaluation history | P1 after live signal ingestion |
...
| Auditing | Search, evidence filters and export | Pass | Restrict chained audit evidence | Implemented platform/security/auditor access |
...
| Reminders | Reminder rules and action entry points | Pass | Add scheduler/notification worker | P1 platform service |
...
| Hybrid AD | Health, sync and operational views | Pass | Add on-premises agent and secure outbound channel | P1 external agent integration |
